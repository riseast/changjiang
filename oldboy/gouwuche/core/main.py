...
def admin_info():
    ...
    if user_data['account_data']['type'] == 1:
        while True:
            print('''\033[35;1m                        ---------------欢迎 %s 来到信用卡管理中心---------------
                                           1.  发行信用卡
                                           2.  冻结信用卡
                                           3.  解冻信用卡
                                           4.  提升信用卡额度
            ...
            inputs = input('\033[35;1m请选择操作方式1>>>:\033[0m').strip()
            menu_dic = {
                "1": admincenter.banks,
